...
new_local_repository(
    name = "cavium_compiler",
    path = "tools/cavium_compiler/mips64_gcc_4.8.4",
    build_file = "tools/cavium_compiler/cavium_compiler.BUILD",
)

new_local_repository(
    name = "arm_compiler",
    path = "tools/arm_compiler/linaro_linux_gcc_repo",
    build_file = "tools/arm_compiler/arm_compiler.BUILD",
)
